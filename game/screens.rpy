...
style choice_button:
    font "gui/fonts/Kanit-Regular.ttf"  # เปลี่ยนเป็นฟอนต์ไทย
    size 30  # ปรับขนาดตัวอักษร
...
style choice_button_text is default:
    ...
    font "gui/fonts/Kanit-Regular.ttf"
    size 30
...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            textbutton _("ถอยกลับ") action Rollback()
            ...
            textbutton _("ออก") action QuickSave()
...
screen navigation():
    ...
    vbox:
        ...
        textbutton _("เกี่ยวกับ") action ShowMenu("about_credits")
...
screen about_credits():
    ...
    add Movie(play="movies/end_credit.webm", xalign=0.5, yalign=0.5, xfill=True, yfill=True)
